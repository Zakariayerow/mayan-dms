...
from .literals import (
    ...
    DEFAULT_EMAIL_HOST_PASSWORD, DEFAULT_EMAIL_HOST_USER, DEFAULT_EMAIL_PORT,
    DEFAULT_EMAIL_TIMEOUT, DEFAULT_EMAIL_USE_SSL, DEFAULT_EMAIL_USE_TLS,
...
setting_django_csrf_cookie_secure = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='Whether to use a secure cookie for the CSRF cookie. '
...
setting_django_csrf_use_sessions = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='Whether to store the CSRF token in the user\'s session '
...
setting_django_default_from_email = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='Default: \'webmaster@localhost\' '
...
setting_django_email_host = setting_namespace.do_setting_add(
    default=DEFAULT_EMAIL_HOST, global_name='EMAIL_HOST', help_text=_(
        message='Default: \'localhost\'. The host to use for sending email.'
    )
)
setting_django_email_host_password = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='Default: \'\' (Empty string). Password to use for the SMTP '
...
setting_django_email_host_user = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='Default: \'\' (Empty string). Username to use for the SMTP '
...
setting_django_email_timeout = setting_namespace.do_setting_add(
    default=DEFAULT_EMAIL_TIMEOUT, global_name='EMAIL_TIMEOUT', help_text=_(
        message='Default: None. Specifies a timeout in seconds for blocking '
...
setting_django_login_url = setting_namespace.do_setting_add(
    default=DEFAULT_LOGIN_URL, global_name='LOGIN_URL', help_text=_(
        message='Default: \'/accounts/login/\' The URL where requests are '
...
setting_django_login_redirect_url = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='Default: \'/accounts/profile/\' The URL where requests are '
...
setting_django_languages = setting_namespace.do_setting_add(
    default=DEFAULT_LANGUAGES, global_name='LANGUAGES', help_text=_(
        message='A list of all available languages. The list is a list of '
...
setting_django_time_zone = setting_namespace.do_setting_add(
    default=DEFAULT_TIME_ZONE, global_name='TIME_ZONE', help_text=_(
        message='A string representing the time zone for this installation. '
...
setting_django_wsgi_application = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='A boolean that specifies whether to use the X-Forwarded-Host '
