...
setting_disable_local_storage = setting_namespace.do_setting_add(
    ...
    global_name='COMMON_DISABLE_LOCAL_STORAGE', help_text=_(
        message='Disables the use of the local `media` folder. When using '
        'this setting, all apps must be also configured via their respective '
...
setting_disabled_apps = setting_namespace.do_setting_add(
    ...
    global_name='COMMON_DISABLED_APPS', help_text=_(
        message='A list of strings designating all applications that are to '
        'be removed from the list normally installed by Mayan EDMS. Each '
...
setting_extra_apps = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='A list of strings designating all applications that are '
        'installed beyond those normally installed by Mayan EDMS. Each '
        'string should be a dotted Python path to: an application '
        'configuration class (preferred), or a package containing an '
        'application. These apps will be installed after the default apps. '
        'Example: [\'app_1\', \'app_2\']'
    )
)
setting_extra_apps_pre = setting_namespace.do_setting_add(
    ...
    help_text=_(
        ...
        'string should be a dotted Python path to: an application '
        'configuration class (preferred), or a package containing an '
        'application. These apps will be installed before the default apps. '
        'Example: [\'app_1\', \'app_2\']'
    )
)
setting_home_view = setting_namespace.do_setting_add(
    ...
    help_text=_(
        message='Name of the view attached to the brand anchor in the main '
        'menu. This is also the view to which users will be redirected after '
        'log in.'
    )
)
