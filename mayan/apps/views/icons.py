...
icon_add_all = Icon(
    driver_name='fontawesome-layers', data=[
        ...
        {'class': 'fa-solid fa-plus', 'transform': 'shrink-6'}
    ]
)
...
icon_confirm_form_cancel = Icon(driver_name='fontawesome', symbol='xmark')
icon_list_mode_list = Icon(
    driver_name='fontawesome', symbol='list'
)
icon_list_mode_items = Icon(
    driver_name='fontawesome', symbol='table-cells-large'
)
icon_remove_all = Icon(
    driver_name='fontawesome-layers', data=[
        {'class': 'fa-regular fa-circle'},
        {'class': 'fa-solid fa-minus', 'transform': 'shrink-6'}
    ]
)
